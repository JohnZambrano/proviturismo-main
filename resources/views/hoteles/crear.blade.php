...
<div class="container-lg py-5">
    <div class="card shadow-lg border-0">
        <h1 class="title">🏨📢 Crear nueva publicación de Hotel 🌟🛎️</h1>

        <div class="card-body px-lg-5 py-4">
            <form action="{{ route('hoteles.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="col-md-12 text-center">
                        <div class="image-preview-container mb-4 position-relative">
                            ...
                            <div id="placeholder" class="text-muted py-5">
                                ...
                                <p class="mb-0">Vista previa de la imagen del hotel</p>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="file-upload-card border-dashed rounded-3 p-4">
                            <label class="d-block text-center cursor-pointer">
                                ...
                                <h5 class="mb-2">Arrastra o selecciona la imagen del hotel</h5>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!form.checkValidity()) {
            ...
            submitBtn.innerHTML = '<i class="fas fa-save me-2"></i>Guardar Hotel';
