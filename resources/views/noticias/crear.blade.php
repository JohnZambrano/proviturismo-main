...
<div class="container-lg py-5">
    <div class="card shadow-lg border-0">
         <h1 class="title">📢 Crear publicaciónes de Noticias 🍣</h1>

        <div class="card-body px-lg-5 py-4">
            <form action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            ...
                            <div class="text-end small text-muted mt-1">
                                <span id="titleCounter">0</span>/120 caracteres
                            </div>
                        </div>
                    </div>
                  ...
                  <!-- Campo Descripción -->
                    <div class="col-md-12">
                        <div class="form-floating">
                            ...
                            <div class="text-end small text-muted mt-1">
                                <span id="descCounter">0</span>/2000 caracteres
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="file-upload-card border-dashed rounded-3 p-4">
                            <label class="d-block text-center cursor-pointer">
                                ...
                                <h5 class="mb-2">Arrastra la imagen o haz clic para subir</h5>
