    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <p>Exhibición de carrozas por las principales calles del municipio acompañadas por danzas.</p>
            </div>
        ...
        <div class="activity-carousel">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_actividades/mayores.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    ...
                    <p>Presentación de comparsas por adultos mayores de barrios y veredas el día 3 de enero.</p>
            ...
            <div class="activity-card" data-aos="zoom-in">
                ...
                <div class="card-content">
                    ...
                    <p>Presentación fonomímica sobre las familias tradicionales de Providencia el día 5 de enero.</p>
                    <div class="icon-group">
                        <i class="fas fa-theater-masks"></i>
                        <i class="fas fa-laugh-beam"></i>
                    </div>
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_actividades/carroza.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    ...
                    <p>Presentación de carrozas y comparsas el día 6 de enero.</p>
                    <div class="icon-group">
                        <i class="fas fa-theater-masks"></i>
                        <i class="fas fa-laugh-beam"></i>
                    </div>
