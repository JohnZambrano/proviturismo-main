...
@section('content')
            ...
            <section class="main-hero" data-aos="fade-down" style="background: linear-gradient(rgba(34,139,34,0.9), rgba(34,139,34,0.7)), url('https://picsum.photos/1920/600?travel') center/cover;">
                <div class="hero-header">
                    <h1 class="main-title">🏕️ Pozos del salado grande🗺️</h1>
    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <p>  Los pozos del salado grande es un lugar tranquilo y rodeado
            ...
            <div class="info-card" data-aos="flip-left">
                ...
                <h3>Accesibilidad: </h3>
                <p> Llegar a los pozos de sal Salado Grande puede ser un desafío,
            ...
            <div class="info-card" data-aos="flip-left">
                ...
                <p>  Aunque actualmente no hay actividades organizadas, el lugar tiene potencial para el turismo,
                     con pozos de sal como principal atractivo.</p>
            </div>

            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-sun"></i>
                <h3>Propuestas de mejora: </h3>
                <p>Se sugiere mejorar los caminos y promocionarlos pozos de sal Salado Grande  como un destino turístico,
    ...
    <section id="actividades" class="activities-section">
        ...
        <div class="activity-carousel">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos3.jpeg') }}" class="d-block w-100" alt="imagen">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos2.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos1.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    <h4>Pozo de Agua Salada: </h4>
                    <p> Un pozo histórico utilizado antiguamente para la extracción de sal.</p>
                    <div class="icon-group">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos7.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    <h4> Áreas Verdes: </h4>
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos4.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    <h4>Pozo de Agua Salada: </h4>
                    <p> Un pozo histórico utilizado antiguamente para la extracción de sal.</p>
                    <div class="icon-group">
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos8.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    <h4>Sendero Natural:</h4>
            ...
            <div class="activity-card" data-aos="zoom-in">
               <img src="{{ asset('img_lugares/pos6.jpeg') }}" class="d-block w-100" alt="imagen">
                <div class="card-content">
                    <h4>Pozo de Agua Salada: </h4>
                    <p> Un pozo histórico utilizado antiguamente para la extracción de sal.</p>
                    <div class="icon-group">
    ...
    <section id="recomendaciones" class="recommendations" data-aos="fade-up">
        <div class="recommendation-box">
            ...
            <blockquote>
                "Los pozos de sal Salado Grande con sus pozos de agua salada y su rica historia, 
