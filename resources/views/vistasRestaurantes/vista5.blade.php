...
@section('content')
    ...
    <section class="main-hero" data-aos="fade-down">
        <div class="hero-header">
            <h1 class="main-title">🍽️ Restaurante El Buen Pollo🍽️</h1>
    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <h3>Desayunos: </h3>
                <p> En El Buen Pollo, los desayunos son rápidos y deliciosos, perfectos para empezar el día con energía. 
                    Disfruta de opciones frescas y sabrosas que te dejarán satisfecho.</p>
            </div>
            
            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-drumstick-bite"></i>
                <h3>Almuerzos: </h3>
                <p> Los almuerzos en El Buen Pollo destacan por su famoso pollo broaster, crujiente y jugoso. Es el lugar
                     ideal para una comida rápida sin sacrificar el sabor y la calidad.</p>
            </div>

            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-cheese"></i>
                <h3>Cenas: </h3>
                <p>  Para la cena, El Buen Pollo ofrece una experiencia rápida y
                     deliciosa con platillos que resaltan su especialidad en pollo broaster. 
                    Perfecto para una noche sin complicaciones pero llena de sabor.</p>
            </div>
     ...
     <section id="menu" class="container my-5 menu-section">
            ...
            <div class="row menu-row">
                <div class="col-md-4 menu-column">
                    ...
                    <ul class="menu-list">
                        <li class="menu-item">Consome- $3.000</li>
                        <li class="menu-item"> Pollo broster con papas - $7.000</li>
                ...
                <div class="col-md-4 menu-column">
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item">Jugo de Mango artificial- $2.000</li>
                    </ul>
                </div>
                <div class="col-md-4 menu-column">
        ...
        <div class="venta-card" style="background: white; border-radius: 20px; padding: 2rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 800px; margin: 0 auto;">
            <div class="contacto-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
                ...
                <div class="contacto-item" style="text-align: center;">
                    ...
                    <h3 style="color: var(--accent);">Restaurante el buen Pollo</h3>
                    <p style="margin: 0.5rem 0;">Carrera 5 #6-8<br>Barrio Libertad</p>
                ...
                <div class="contacto-item" style="text-align: center;">
                    ...
                    <div style="margin: 1rem 0;">
                        <a href="tel:+573001234567" style="text-decoration: none; color: var(--accent); font-size: 1.2rem;">
                            <i class="fas fa-phone-volume"></i> 3124128566
                        </a>
                    </div>
                    <div style="margin: 1rem 0;">
                        <a href="https://wa.me/573124128566" target="_blank" style="text-decoration: none; color: #25D366;">
