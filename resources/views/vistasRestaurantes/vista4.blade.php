...
@section('content')
    ...
    <section class="main-hero" data-aos="fade-down">
        <div class="hero-header">
            <h1 class="main-title">🍽️ Restaurante Melbis🍽️</h1>
    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <h3>Desayunos: </h3>
                <p> En Melbis Restaurante, los desayunos son una celebración de la pasión por la cocina. 
            ...
            <div class="info-card" data-aos="flip-left">
                ...
                <h3>Almuerzos: </h3>
                <p>  Los almuerzos en Melbis son una experiencia culinaria auténtica, 
            ...
            <div class="info-card" data-aos="flip-left">
                ...
                <h3>Cenas: </h3>
                <p> Para la cena, Melbis ofrece un ambiente encantador donde los
