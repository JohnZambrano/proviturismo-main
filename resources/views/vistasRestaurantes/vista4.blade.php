...
@section('content')
    ...
    <section class="main-hero" data-aos="fade-down">
        <div class="hero-header">
            <h1 class="main-title">🍽️ Restaurante Melvis🍽️</h1>
    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <h3>Desayunos: </h3>
                <p> En Melvis Restaurante, los desayunos son una celebración de la pasión por la cocina.
                    Disfruta de platos auténticos que resaltan los sabores frescos de Nariño desde temprano en la mañana.</p>
            </div>
           
            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-drumstick-bite"></i>
                <h3>Almuerzos: </h3>
                <p>  Los almuerzos en Melvis son una experiencia culinaria auténtica,
                    con platos elaborados con dedicación. Cada bocado destaca los ingredientes locales
                     y la tradición de la región.</p>
            </div>
            ...
            <div class="info-card" data-aos="flip-left">
                ...
                <h3>Cenas: </h3>
                <p> Para la cena, Melvis ofrece un ambiente encantador donde los
                     sabores de Nariño son los protagonistas. Saborea platos
                      cuidadosamente preparados que reflejan la pasión por la cocina y la autenticidad regional.</p>
            </div>
            ...
            <div class="row menu-row">
                ...
                <div class="col-md-4 menu-column">
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item">Café con arepa - $5.000</li>
                        <li class="menu-item">Café con empanadas- $5.000</li>
                    </ul>
                </div>
                <div class="col-md-4 menu-column">
        ...
        <div class="venta-card" style="background: white; border-radius: 20px; padding: 2rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 800px; margin: 0 auto;">
            <div class="contacto-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
                ...
                <div class="contacto-item" style="text-align: center;">
                    ...
                    <h3 style="color: var(--accent);">Restaurante Melbis</h3>
