...
@section('content')
    ...
    <section class="main-hero" data-aos="fade-down">
        <div class="hero-header">
            <h1 class="main-title">🍽️ Restaurante La Tradición del Sabor🍽️</h1>
    ...
    <section id="descripcion" class="section-info" data-aos="fade-up">
        ...
        <div class="info-cards">
          ...
          <div class="info-card" data-aos="flip-left">
                ...
                <h3>Desayunos: </h3>
                <p> En La Tradición del Sabor, los desayunos son una experiencia acogedora y familiar. Disfruta de platos tradicionales
                     que resaltan los sabores auténticos de la región desde temprano en la mañana.</p>
            </div>
            
            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-drumstick-bite"></i>
                <h3>Almuerzos: </h3>
                <p>  Los almuerzos en La Tradición del Sabor son perfectos para disfrutar 
                    en grupo, con una oferta gastronómica que destaca la cocina tradicional.
                     Cada plato está elaborado con ingredientes frescos y locales.</p>
            </div>

            <div class="info-card" data-aos="flip-left">
                <i class="fas fa-cheese"></i>
                <h3>Cenas: </h3>
                <p>  Para la cena, La Tradición del Sabor ofrece un
                     ambiente cálido y familiar, ideal para compartir con seres queridos.
                     Saborea platos deliciosos que reflejan la tradición y el sabor auténtico de la región.</p>
            </div>
        ...
        <div class="venta-card" style="background: white; border-radius: 20px; padding: 2rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 800px; margin: 0 auto;">
            <div class="contacto-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
                ...
                <div class="contacto-item" style="text-align: center;">
                    ...
                    <h3 style="color: var(--accent);">Restaurante la Tradición del Sabor</h3>
                    <p style="margin: 0.5rem 0;">Carrera 5 #6-8<br>Barrio Laureles</p>
                ...
                <div class="contacto-item" style="text-align: center;">
                    ...
                    <div style="margin: 1rem 0;">
                        <a href="https://wa.me/573001234567" target="_blank" style="text-decoration: none; color: #25D366;">
