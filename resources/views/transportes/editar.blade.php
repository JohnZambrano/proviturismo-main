...
<div class="container">
    ...
    <form action="{{ route('transportes.update', $transporte->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <label for="nombre" class="form-label">Nombre de la empresa de transporte:</label>
                <div class="invalid-feedback">Por favor ingrese un nombre válido</div>
                <input type="text" name="nombre" id="nombre" class="form-control" 
                 value="{{ $transporte->nombre }}" required maxlength="255">
            ...
            <div class="col-md-6">
                ...
                <textarea name="descripcion" id="descripcion" 
                    ...
                    required 
                    style="min-height: 120px; max-height: 300px; overflow-y: auto; resize: none">{{ old('descripcion', $transporte->descripcion) }}
                </textarea>
        ...
        <div class="row mt-5">
            <div class="col-md-4 position-relative">
                <div class="image-preview-container">
                    <img src="{{ asset('storage/' . $transporte->imagen) }}" 
                         class="img-fluid rounded transporte-current-image"
                         id="imagenSeleccionada"
                         alt="Imagen actual de empresa de transporte">
                    <button type="button" 
        ...
        <div class="d-grid gap-3 d-md-flex justify-content-md-end mt-5">
                ...
                <a href="{{ route('transportes.index') }}" class="btn btn-outline-secondary btn-lg px-4">
