                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <textarea 
                                ...
                                placeholder="Descripción de la empresa de transporte"
                    ...
                    <div class="col-md-12 text-center">
                        <div class="image-preview-container mb-4 position-relative">
                            ...
                            <div id="placeholder" class="text-muted py-5">
                                ...
                                <p class="mb-0">Vista previa de la imagen de la empresa de Transporte</p>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="file-upload-card border-dashed rounded-3 p-4">
                            <label class="d-block text-center cursor-pointer">
                                ...
                                <h5 class="mb-2">Arrastra o selecciona la imagen de la empresa de transporte</h5>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!form.checkValidity()) {
            ...
            submitBtn.innerHTML = '<i class="fas fa-save me-2"></i>Guardar empresa de Transporte';
