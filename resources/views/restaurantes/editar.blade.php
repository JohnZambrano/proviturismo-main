        ...
        <div class="row mt-5">
            <div class="col-md-6">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control" 
                 value="{{ $restaurante->nombre }}" required maxlength="255">
            ...
            <div class="col-md-6">
                ...
                <textarea name="descripcion" id="descripcion" 
                    ...
                    required 
                    style="min-height: 120px; max-height: 300px; overflow-y: auto; resize: none">{{ old('descripcion', $restaurante->descripcion) }}
                </textarea>
